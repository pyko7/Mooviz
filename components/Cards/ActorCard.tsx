    ...
    <article className="w-3/4 min-w-[175px] lg:min-w-0 p-4 rounded-xl shadow-lg dark:shadow-white/10 lg:my-0 lg:mx-auto sm:w-full">
      <div className="w-full h-full flex flex-col lg:gap-y-4">
        ...
        <div className="w-full mt-2">
          <h3
            className={
              "w-full font-bold text-lg line-clamp-2 text-center dark:text-gray-200 md:text-lg sm:text-lg"
            }
          >
            {actor.character}
          </h3>
          <h4
            className={
              "w-full text-base line-clamp-2 text-center dark:text-gray-300 md:text-lg sm:text-lg"
            }
          >
            {actor.name}
          </h4>

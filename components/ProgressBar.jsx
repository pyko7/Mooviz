    ...
    return (
        <div
            style={{
                background:
                    percentage < 50
                        ? `conic-gradient(#ef4444 ${percentage * 3.6
                        }deg, #fca5a5 ${percentage * 3.6}deg)`
                        : percentage > 50 && percentage < 70
                            ? `conic-gradient(#fde047 ${percentage * 3.6
                            }deg, #fef9c3 ${percentage * 3.6}deg)`
                            : `conic-gradient(#22c55e ${percentage * 3.6
                            }deg, #86efac ${percentage * 3.6}deg)`,
            }}
